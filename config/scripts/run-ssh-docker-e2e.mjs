...
const env = {
  ...process.env,
  ALICORN_E2E_SSH_DOCKER: '1',
  ALICORN_E2E_WEB_CLIENT: '1'
}
...
// Why one explicit list: these specs self-skip without ALICORN_E2E_SSH_DOCKER and no sharded lane
...
//       local-ssh-browser-routing (ALICORN_E2E_LOCAL_SSH_BROWSER)
//       ssh-client-hosted-browser-drop-reconnect (ALICORN_E2E_SSH_CLIENT_HOSTED_BROWSER)
//       nested-runtime-ssh-lifecycle, nested-runtime-ssh-routing (ALICORN_E2E_NESTED_RUNTIME_SSH)
//       ssh-localhost (ALICORN_E2E_SSH_LOCALHOST)
//       ssh-browser-network-execution-route.docker.unit.test.ts (ALICORN_RUN_DOCKER_SSH_BROWSER_E2E)
