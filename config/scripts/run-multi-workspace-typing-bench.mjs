...
const knobByFlag = {
  '--panes': 'ALICORN_TYPING_BENCH_LOAD_PANES',
  '--rate-kbps': 'ALICORN_TYPING_BENCH_RATE_KBPS',
  '--keys': 'ALICORN_TYPING_BENCH_KEYS',
  '--cadence-ms': 'ALICORN_TYPING_BENCH_KEY_CADENCE_MS',
  '--cpu-workers': 'ALICORN_TYPING_BENCH_CPU_WORKERS',
  '--label': 'ALICORN_TYPING_BENCH_LABEL'
}

const env = { ...process.env, ALICORN_TYPING_BENCH: '1' }
