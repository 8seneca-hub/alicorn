...
export const DEV_BUNDLE_ID = 'com.8seneca.alicorn.dev'
...
// Why still "Orca Dev" after the rebrand: this must equal BASE_APP_NAME in
// src/main/startup/dev-instance-identity.ts, which names the dev safeStorage Keychain item
// (dev-electron-bundle-identity.test.ts pins the pair). Renaming either orphans every dev
// instance's stored secrets, so both flip together with R2 — not one at a time.
