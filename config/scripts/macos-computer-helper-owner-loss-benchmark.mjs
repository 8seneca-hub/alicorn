...
const INTERNAL_ENV = 'ALICORN_COMPUTER_HELPER_OWNER_BENCH_INTERNAL'
const EXPECTATION_ENV = 'ALICORN_COMPUTER_HELPER_OWNER_BENCH_EXPECTATION'
const HELPER_RECORD_PATH_ENV = 'ALICORN_COMPUTER_HELPER_OWNER_BENCH_HELPER_RECORD_PATH'
const RESULT_PATH_ENV = 'ALICORN_COMPUTER_HELPER_OWNER_BENCH_RESULT_PATH'
...
function startSidecar() {
  ...
  const child = fork(sidecarPath, [], {
    ...
    env: {
      ...
      ALICORN_COMPUTER_SIDECAR: '1',
      ALICORN_COMPUTER_MACOS_HELPER_APP_PATH: helperAppPath
    }
  })
