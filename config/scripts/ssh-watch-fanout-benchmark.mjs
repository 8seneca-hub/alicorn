...
const ITERATIONS = Number(process.env.ALICORN_SSH_WATCH_BENCH_ITERATIONS ?? '200')
const WARMUP = Number(process.env.ALICORN_SSH_WATCH_BENCH_WARMUP ?? '30')

for (const [name, value] of [
  ['ALICORN_SSH_WATCH_BENCH_ITERATIONS', ITERATIONS],
  ['ALICORN_SSH_WATCH_BENCH_WARMUP', WARMUP]
]) {
