...
const ITERATIONS = Number(process.env.ALICORN_SC_SORT_BENCH_ITERATIONS ?? '25')
const WARMUP = Number(process.env.ALICORN_SC_SORT_BENCH_WARMUP ?? '5')

for (const [name, value] of [
  ['ALICORN_SC_SORT_BENCH_ITERATIONS', ITERATIONS],
  ['ALICORN_SC_SORT_BENCH_WARMUP', WARMUP]
]) {
