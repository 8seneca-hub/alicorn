...
const f = (t) => (t <= 0.0031308 ? 12.92 * t : 1.055 * t ** (1 / 2.4) - 0.055)
export function oklch(L, C, H) {
  ...
  const inGamut =
    r >= -0.001 && r <= 1.001 && g >= -0.001 && g <= 1.001 && bb >= -0.001 && bb <= 1.001
  const R = Math.round(f(cl(r)) * 255),
    G = Math.round(f(cl(g)) * 255),
    B = Math.round(f(cl(bb)) * 255)
  return {
