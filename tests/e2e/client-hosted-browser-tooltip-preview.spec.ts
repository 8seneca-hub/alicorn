...
// Run: ALICORN_TOOLTIP_PREVIEW=1 pnpm exec playwright test --config tests/playwright.config.ts \
...
test.skip(
  process.env.ALICORN_TOOLTIP_PREVIEW !== '1',
  'Preview only; run with ALICORN_TOOLTIP_PREVIEW=1'
)
