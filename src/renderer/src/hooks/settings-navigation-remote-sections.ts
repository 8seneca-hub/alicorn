  ...
  return [
      ...
      : []),
    {
      ...
      title: translate(
        ...
        'Remote Alicorn Servers'
      ),
      description: isWebClient
        ? 'Connect this browser to a saved Alicorn server.'
        : 'Pair remote Alicorn runtimes for persistent sessions, richer remote state, and web or mobile handoff.',
      icon: Server,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'Install and manage experimental Alicorn plugins.'
            ),
            icon: Blocks,
    ...
    // multiple hosts (local + a Remote Alicorn Server, or two clones) collapses to
