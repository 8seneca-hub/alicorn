export const ALICORN_TERMINAL_COMMAND_FINISHED_EVENT = 'orca:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(ALICORN_TERMINAL_COMMAND_FINISHED_EVENT, {
