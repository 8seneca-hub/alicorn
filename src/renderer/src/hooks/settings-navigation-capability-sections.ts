...
import { AlicornLogoSettingsIcon } from '@/components/settings/alicorn-logo-settings-icon'
  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Coordinate multiple coding agents through Alicorn.'
      ),
      icon: Network,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'How Linear works in Alicorn, setup checklist, agent skill, and example prompts.'
            ),
            icon: LinearIcon,
  ...
  return [
    ...(showDesktopOnlySettings
      ? [
          {
            id: 'orca-account',
            title: translate('auto.components.settings.orcaAccount.title', 'Alicorn Account'),
            description: translate(
              'auto.components.settings.orcaAccount.description',
              'Share work instantly and reach your desktop from Alicorn Mobile wherever you are.'
            ),
      ...
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core Alicorn workflows.'
      ),
      icon: AlicornLogoSettingsIcon,
      searchEntries: [
        {
          title: translate(
            'auto.hooks.useSettingsNavigationMetadata.ded9e9032f',
