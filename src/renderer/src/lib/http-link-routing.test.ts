...
describe('openHttpLink', () => {
  it('routes into Alicorn when openLinksInApp is on and a worktree is known', () => {
  ...
  it('routes floating workspace links into Alicorn without changing the active repo worktree', () => {
    storeState.settings = { openLinksInApp: true }
  ...
  it('forceInApp opens a local link in Alicorn when the setting is off', () => {
    storeState.settings = { openLinksInApp: false }
  ...
  it('does not force a remote link into the Alicorn browser', () => {
    storeState.settings = { openLinksInApp: false }
...
describe('openHttpLink modifier routing', () => {
  it('forces the system browser when inverting is off and links open in Alicorn', () => {
  ...
  it('opens in Alicorn when inverting is on and links open externally', () => {
  ...
  it('opens in the system browser when inverting is on and links open in Alicorn', () => {
  ...
  // Why: remote-owned links must never land in an Alicorn tab that cannot reach them.
  it('never routes a remote source into Alicorn even when inverting', () => {
    storeState.settings = { openLinksInApp: false, openLinksInAppModifierInverts: true }
