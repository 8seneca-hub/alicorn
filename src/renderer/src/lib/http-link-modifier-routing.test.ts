...
describe('resolveModifierRouting', () => {
  ...
  it('still reaches the system browser when inverting and links open in Alicorn', () => {
  ...
  it('reaches Alicorn when inverting and links open in the system browser', () => {
...
describe('modifier routing across link source owners', () => {
  ...
  it('still lets the inverting modifier pull a local link into Alicorn', () => {
  ...
  it('lets an inverting modifier reach Alicorn on the owning runtime', () => {
    storeState.settings = {
