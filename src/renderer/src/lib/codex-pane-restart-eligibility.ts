 ...
 * process in the PTY tree, so an Alicorn "Codex" pane running a subagent reads as
 ...
 * recorded metadata (Alicorn started Codex in this tab), not a repaintable label,
