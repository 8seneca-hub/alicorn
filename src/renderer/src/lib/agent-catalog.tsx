...
export const getAgentCatalog = createLocalizedCatalog((): AgentCatalogEntry[] => [
  ...
  },
  {
    ...
    cmd: 'openclaude',
    // Why: OpenClaude's published favicon has a padded 500px canvas; Alicorn
  ...
  },
  {
    ...
    // the settings pane's "default command" hint aligns with what Alicorn
  ...
  },
  {
    ...
    // suggestion that Alicorn is looking for Windows' built-in `cmd.exe`.
    cmd: 'command-code',
