...
export const createOrcaProfilesSlice: StateCreator<AppState, [], [], OrcaProfilesSlice> = (
  ...
  fetchOrcaProfiles: async () => {
    ...
    try {
      ...
      console.error('Failed to fetch Alicorn profiles:', err)
  ...
  fetchOrcaProfileAuthStatus: async () => {
    try {
      ...
      console.error('Failed to fetch Alicorn profile auth status:', err)
      return null
    }
  },
  ...
  createLocalOrcaProfile: async (name) => {
    try {
      ...
      console.error('Failed to create Alicorn profile:', err)
      toast.error(
  ...
  switchOrcaProfile: async (profileId) => {
    ...
    try {
      ...
      console.error('Failed to switch Alicorn profile:', err)
      set({ orcaProfileSwitching: false })
      toast.error(
  ...
  transferOrcaProfileProject: async (args) => {
    try {
      ...
      console.error('Failed to transfer Alicorn profile project:', err)
      toast.error(
