...
describe('connectPanePty', () => {
  ...
  it('clears pre-hook launch config when an Alicorn-started command exits', async () => {
  ...
  it('confirms an Alicorn-launched Droid fresh spawn in a no-OSC shell (Git Bash)', async () => {
