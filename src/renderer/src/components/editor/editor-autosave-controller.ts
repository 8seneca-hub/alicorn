import {
  ...
  ALICORN_EDITOR_EXTERNAL_FILE_CHANGE_EVENT,
  ALICORN_EDITOR_QUIESCE_FILE_SAVES_EVENT,
  ALICORN_EDITOR_SAVE_AND_CLOSE_EVENT,
  ALICORN_EDITOR_SAVE_FILE_EVENT,
...
import {
  ...
  ALICORN_EDITOR_SAVE_DIRTY_FILES_EVENT
...
export function attachEditorAutosaveController(store: AppStoreApi): () => void {
  ...
  window.addEventListener(ALICORN_EDITOR_SAVE_AND_CLOSE_EVENT, handleSaveAndClose as EventListener)
  window.addEventListener(ALICORN_EDITOR_SAVE_FILE_EVENT, handleSaveFile as EventListener)
  window.addEventListener(ALICORN_EDITOR_QUIESCE_FILE_SAVES_EVENT, handleQuiesce as EventListener)
  window.addEventListener(
    ALICORN_EDITOR_EXTERNAL_FILE_CHANGE_EVENT,
  ...
  return () => {
    ...
    window.removeEventListener(ALICORN_EDITOR_SAVE_FILE_EVENT, handleSaveFile as EventListener)
    window.removeEventListener(
      ALICORN_EDITOR_QUIESCE_FILE_SAVES_EVENT,
