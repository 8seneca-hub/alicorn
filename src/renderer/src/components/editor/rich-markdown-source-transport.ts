...
const TRANSPORT_PREFIX = '[[ALICORN_RICH_MD:'
const TRANSPORT_SUFFIX = ']]'
const KEY_PATTERN = /^[a-f0-9]{32}$/
const TRANSPORT_BODY_PATTERN =
  /^ALICORN_RICH_MD:[a-f0-9]{32}:(?:literal|inline-html|block-html|document-link|html-superscript-link):/
const LEGACY_PREFIXES = [
  'ALICORN_RAW_HTML_INLINE:',
  'ALICORN_RAW_HTML_BLOCK:',
  'ALICORN_DOC_LINK:'
] as const
