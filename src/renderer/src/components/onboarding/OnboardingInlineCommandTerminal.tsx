...
import {
  ALICORN_TERMINAL_COMMAND_FINISHED_EVENT,
...
export function OnboardingInlineCommandTerminal({
  ...
  useEffect(() => {
    ...
    window.addEventListener(ALICORN_TERMINAL_COMMAND_FINISHED_EVENT, handleCommandFinished)
    return () => {
      window.removeEventListener(ALICORN_TERMINAL_COMMAND_FINISHED_EVENT, handleCommandFinished)
    }
