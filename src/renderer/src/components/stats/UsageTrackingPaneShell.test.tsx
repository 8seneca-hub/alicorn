    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="orca"
          options={[
            { value: 'orca', label: 'Alicorn worktrees only' },
      ...
      selectionSummary="Alicorn worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Alicorn worktrees only • Last 7 days')).toBeInTheDocument()
