    ...
    if (!shareId) {
      setError(
        translate(
          ...
          'Enter an Alicorn skill share link.'
        )
      )
      return
    }
    ...
    try {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Alicorn account before installing.'
              )
            : operation.message
        )
        return
      ...
      setError(
        translate(
          ...
          'Installation failed before Alicorn could verify the requested version.'
        )
      )
    } finally {
