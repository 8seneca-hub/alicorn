...
function operationError(status: string): string {
  return status === 'reconnect-required'
    ? translate(
        ...
        'Reconnect your Alicorn account before sharing.'
      )
    : translate(
        'auto.components.skills.SkillShareDialog.unconfigured',
        'Connect an Alicorn Cloud account before sharing.'
      )
}
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Alicorn could not send the cancellation request. The upload may still finish.'
        )
      )
    }
  }
