...
export function skillInstallManagementCopy() {
  return {
    title: translate(
      ...
      'Installed by Alicorn'
    ),
    description: translate(
      'auto.components.skills.SkillInstallManagementDialog.3677ae58e7',
      'Skills Alicorn installed from a link. Reinstall, go back to an earlier version, or remove them.'
    ),
    ...
    noInstalls: translate(
      ...
      'Alicorn has not installed any skills on this machine yet.'
    ),
