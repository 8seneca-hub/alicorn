  ...
  switch (reason) {
    case 'bundled': {
      return translate(
        ...
        'Bundled with Alicorn — it would be restored'
      )
    }
    case 'plugin': {
      return translate(
    ...
    case 'unowned': {
      return translate(
        ...
        'This skill lives outside Alicorn’s skill folders — delete it where it is stored'
      )
    }
    case 'missing': {
      return translate(
...
/**
 * A skill whose content lives outside every Alicorn root is removed by its links
