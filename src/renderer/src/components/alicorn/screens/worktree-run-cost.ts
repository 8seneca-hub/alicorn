/**
 * What a set of worktrees has spent: their dispatches, summed through D7's own `summarizeRunCost`.
 *
 * Keyed by worktree rather than by project because a project and a task are the same sum over
 * different sets — a project's repos' worktrees, or the ones a task is bound to.
 *
...
export function summarizeWorktreeRunCost({
  worktreeIds,
  tabsByWorktree,
