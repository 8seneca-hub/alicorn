...
/** True when an existing Alicorn host already owns this config alias / label. */
 ...
 *  otherwise an alias it greys out as "In Alicorn" is still savable as a second target. */
