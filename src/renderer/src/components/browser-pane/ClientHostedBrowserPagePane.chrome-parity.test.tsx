...
describe('ClientHostedBrowserPagePane chrome parity', () => {
  ...
  it('keeps a Kagi session token out of the stored page and the address bar', () => {
    ...
    // The guest still gets the real link — redaction is about what Alicorn keeps, not what loads.
  ...
  it('says so when the page asks for a permission Alicorn denied', () => {
    renderPane()
    ...
    expect(toastMocks.message).toHaveBeenCalledWith(
      'https://example.internal asked for camera or microphone access, and Alicorn denied it.',
