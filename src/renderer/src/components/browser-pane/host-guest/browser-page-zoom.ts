...
export const ALICORN_BROWSER_PAGE_ZOOM_EVENT = 'orca:browser-page-zoom'
...
export function addBrowserPageZoomEventListener(
  ...
  window.addEventListener(ALICORN_BROWSER_PAGE_ZOOM_EVENT, listener)
  return () => window.removeEventListener(ALICORN_BROWSER_PAGE_ZOOM_EVENT, listener)
}
