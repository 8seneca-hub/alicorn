...
type Editing = { id: string | null; draft: MemberInput; skillsText: string } | null
...
export function AlicornMembersPane(): React.JSX.Element {
  ...
  const submit = useCallback(async () => {
    ...
    const input: MemberInput = { ...editing.draft, skills: parseSkills(editing.skillsText) }
    setSaving(true)
      ...
      <SettingsSubsectionHeader
        ...
        action={
          <Button
            ...
            onClick={() => setEditing({ id: null, draft: { ...EMPTY_MEMBER }, skillsText: '' })}
          >
