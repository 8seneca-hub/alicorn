...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'alicorn-ide'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `alicorn-ide` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Alicorn itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Alicorn will register {{value0}} so the command works from WSL terminals.',
