...
const updateCapableCallers = new Map<string, readonly string[]>([
  ...
  [
    ...
    ['ALICORN_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={cliSkillUpdateCommand}']
  ],
  [
    'src/renderer/src/components/settings/BrowserUsePane.tsx',
    ['ALICORN_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={browserUseUpdateCommand}']
  ],
  [
  ...
  [
    ...
    ['ALICORN_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
  ...
  [
    ...
    [
      ...
      'buildSkillCommandForRuntime(ALICORN_CLI_SKILL_INSTALL_COMMAND)',
      'buildSkillCommandForRuntime(ALICORN_CLI_SKILL_UPDATE_COMMAND)'
    ]
  ]
])
...
describe('AgentSkillSetupPanel installed-command call sites', () => {
  ...
  it('routes the combined feature-tip install through runtime command setup', () => {
    ...
    expect(source).not.toContain('command={ALICORN_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND}')
