...
describe('PrivacyPane — isEnvBlocked', () => {
  ...
  it('returns true for ALICORN_TELEMETRY_DISABLED', () => {
...
describe('PrivacyPane — envVarNameForReason', () => {
  ...
  it('maps orca_disabled to ALICORN_TELEMETRY_DISABLED', () => {
    expect(envVarNameForReason('orca_disabled')).toBe('ALICORN_TELEMETRY_DISABLED')
  })
...
describe('PrivacyPane — computeBlockedReason', () => {
  ...
  it('names ALICORN_TELEMETRY_DISABLED as the env reason when set', () => {
