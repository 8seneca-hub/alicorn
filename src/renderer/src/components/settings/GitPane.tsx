...
const KEEP_LOCAL_MAIN_UP_TO_DATE_DESCRIPTION =
  'When you create a workspace, Alicorn refreshes the remote base and safely fast-forwards your matching local branch, such as main or master. This keeps commands like git diff main...HEAD from comparing against stale history. Alicorn skips the update if that branch has uncommitted changes or local-only commits.'
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When you create a workspace, Alicorn refreshes the remote base and safely fast-forwards your matching local branch, such as'
            )}{' '}
            ...
            {translate(
              ...
              'from comparing against stale history. Alicorn skips the update if that branch has uncommitted changes or local-only commits.'
            )}
          </p>
        </div>
        <Switch
