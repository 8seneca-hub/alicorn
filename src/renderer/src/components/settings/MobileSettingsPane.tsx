    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Alicorn Mobile from the'
            )}{' '}
            <button
              type="button"
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Alicorn Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Alicorn Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Alicorn Mobile shortcut in the sidebar.'
          )}
