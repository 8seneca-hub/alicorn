        ...
        <ol className="ml-4 list-decimal space-y-1 text-xs text-muted-foreground">
          <li>
            {translate(
              ...
              'Open Settings → Remote Alicorn Servers → Share this host.'
            )}
          </li>
          <li>
            {translate(
          ...
          <li>
            {translate(
              ...
              'Generate the link, then copy the “Pair another Alicorn client” link.'
            )}
          </li>
        </ol>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-[minmax(0,180px)_minmax(0,1fr)]">
        <div className="space-y-2">
          <Label htmlFor="runtime-server-name">
            {translate('auto.components.settings.RuntimeHostAccessForm.name', 'Name in Alicorn')}
          </Label>
          <Input
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'This only changes how the computer appears in Alicorn.'
            )}
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p id="runtime-server-access-link-help" className="text-xs text-muted-foreground">
            {translate(
              ...
              'Alicorn shows the destination before connecting. Credentials stay hidden.'
            )}
          </p>
          {inputError ? (
          ...
          <div className="text-sm font-medium text-destructive">
            {failure.kind === 'host-identity-mismatch'
              ? translate(
                  ...
                  'The reached Alicorn host does not match this access link'
                )
              : failure.kind === 'access-link-invalid'
                ...
                : failure.kind === 'protocol-incompatible'
                  ? translate(
                      ...
                      'Alicorn versions are not compatible'
                    )
