    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Configured via environment variables. Unset the ALICORN_BITBUCKET_* variables to manage this credential in Alicorn.'
        )}
      </p>
    )
  }
      ...
      <p className="text-xs text-muted-foreground">
        {props.storedCredential
          ...
          : translate(
              ...
              'Bitbucket credentials are configured but could not authenticate. Check the token and repository permissions, then restart Alicorn if environment variables changed.'
            )}
      </p>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Saved in Alicorn on this machine. ALICORN_BITBUCKET_* environment variables take precedence when set.'
        )}
      </p>
    )
  }
