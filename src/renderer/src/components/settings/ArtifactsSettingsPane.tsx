      ...
      : [
          {
            ...
            description: isWebClient
              ? translate(
                  ...
                  'Open Settings → Artifacts in the Alicorn desktop app on the host device and enable publishing.'
                )
              : translate(
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              {translate(
                ...
                'Use your Alicorn account to upload artifacts and manage their public links.'
              )}
            </p>
          </div>
          <Button
          ...
          >
            {connecting
              ...
              : authStatus?.state === 'reconnect-required'
                ...
                : translate('auto.components.settings.artifacts.signIn', 'Sign in to Alicorn')}
          </Button>
        </section>
      ) : null}
