            ...
            {isDesktopWindows ? (
              ...
              >
                <SettingsSwitchRow
                  ...
                  // Why: platform constraint + "close keeps Alicorn running" consequence are
                  // both non-obvious from the label alone.
                  description={translate(
                    'auto.components.settings.AppearancePane.b707773a0d',
                    'When enabled, closing the window keeps Alicorn running in the system tray instead of quitting.'
                  )}
              ...
              >
                <SettingsSwitchRow
                  ...
                  description={translate(
                    ...
                    'Keep an Alicorn shortcut and activity indicator in the macOS menu bar.'
                  )}
