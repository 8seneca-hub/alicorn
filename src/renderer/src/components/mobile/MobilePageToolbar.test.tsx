...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Alicorn Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Alicorn Mobile')
  })

  it('labels the restore action explicitly when Alicorn Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
