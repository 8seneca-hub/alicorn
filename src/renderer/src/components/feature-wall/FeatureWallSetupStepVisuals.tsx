...
// Mac-style terminal traffic-light dots — the signature of an Alicorn terminal pane.
...
// Use Alicorn's browser: a browser pane with a cursor grabbing one highlighted
