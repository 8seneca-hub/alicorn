...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Alicorn's browser",
    subtitle: "Use Alicorn's browser",
    description:
      'Browse your web app without leaving Alicorn. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Alicorn CLI',
    subtitle: 'Enable Alicorn CLI',
    description:
      'Register the Alicorn shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Alicorn so you can start agent work without hunting for folders.'
  }
] as const
