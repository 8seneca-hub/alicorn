...
// a closed set (the native literal plus the labels Alicorn synthesizes from Cursor hooks),
...
// Alicorn's hook-synthesized spinner state, but only once a Cursor-owned title already
