export const TERMINAL_SESSION_STATE_SAVE_FAILED_CODE = 'ALICORN_TERMINAL_SESSION_STATE_SAVE_FAILED'

export const TERMINAL_SESSION_STATE_SAVE_FAILED_MESSAGE =
  'Alicorn could not save this terminal session because local storage is unavailable.'
