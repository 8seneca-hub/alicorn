...
// discipline sits between Alicorn and the querying program can echo it straight back out as
...
//
// The reply is written IMMEDIATELY, in the caller's turn. Alicorn used to withhold it until
