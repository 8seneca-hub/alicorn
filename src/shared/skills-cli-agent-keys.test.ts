...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Alicorn can detect', () => {
  ...
  it("follows Alicorn's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Alicorn detects trae via `traecli`, which tui-agent-config calls an alias
