...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  {
    ...
    docsUrl: 'https://www.alicorn.8seneca.com/docs/model/worktrees'
  },
  {
    id: 'tile-02',
    kind: 'media',
    ...
    owner: 'terminal',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/terminal'
  },
  {
    id: 'tile-03',
    kind: 'media',
    ...
    docsUrl: 'https://www.alicorn.8seneca.com/docs/review/linear'
  },
  {
    id: 'tile-04',
    kind: 'media',
    ...
    docsUrl: 'https://www.alicorn.8seneca.com/docs/agents/supported'
  },
  {
    id: 'tile-05',
    kind: 'media',
    ...
    docsUrl: 'https://www.alicorn.8seneca.com/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    caption:
      'Run agents on a remote machine with the same Alicorn editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
    posterPath: 'tile-06.poster.jpg',
    recordedAtPath: 'tile-06.recorded-at.json',
    owner: 'ssh-workspaces',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
    ...
    owner: 'diff-review',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/review/annotate-ai-diff'
  },
  {
    id: 'tile-09',
    kind: 'media',
    title: 'Alicorn CLI',
    caption: 'Agents can drive Alicorn too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
    posterPath: 'tile-09.poster.jpg',
    recordedAtPath: 'tile-09.recorded-at.json',
    owner: 'orca-cli',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/cli/overview'
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://www.alicorn.8seneca.com/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://www.alicorn.8seneca.com/docs/editing/viewers'
  }
] as const
