...
const REQUEST_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    ...
    message: 'Timed out waiting for the remote Alicorn runtime to respond.'
  },
  {
  ...
  },
  {
    ...
    message: 'Could not connect to the remote Alicorn runtime.'
  },
  {
    producer: 'remote-runtime-client.ts:270 / :667 (formatRemoteRuntimeCloseMessage, 1006)',
    code: 'remote_runtime_unavailable',
    message: 'Remote Alicorn runtime closed the connection.'
  },
  {
    producer: 'remote-runtime-client.ts:270 / :667 (formatRemoteRuntimeCloseMessage, 1011)',
    code: 'remote_runtime_unavailable',
    message: `Remote Alicorn runtime closed the connection (1011: ${CLOSE_REASON.toString()}).`
  },
  {
    producer: 'remote-runtime-client.ts:289',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned an unexpected binary frame.'
  },
  {
    producer: 'remote-runtime-client.ts:310 / :693',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned an undecryptable frame.'
  },
  {
    producer: 'remote-runtime-client.ts:393 / :801 (rejected token)',
    code: 'unauthorized',
    message: 'Remote Alicorn runtime rejected the pairing token.'
  },
  {
    producer: 'remote-runtime-client.ts:393 / :801 (unparseable auth failure)',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned an invalid E2EE auth frame.'
  },
  {
    producer: 'remote-runtime-client.ts:415',
    code: 'remote_runtime_unavailable',
    message: 'Remote Alicorn runtime request was released before it could be sent.'
  },
  {
    producer: 'remote-runtime-client.ts:459 / :829',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned a mismatched response id.'
  },
  {
  ...
  },
  {
    ...
    code: 'runtime_timeout',
    message: 'Timed out waiting for the remote Alicorn runtime subscription to start.'
  },
  {
    producer: 'remote-runtime-client.ts:587',
    code: 'remote_runtime_unavailable',
    message: 'Remote Alicorn runtime send buffer overflow; reconnecting.'
  },
  {
    producer: 'remote-runtime-client.ts:735',
    code: 'remote_runtime_unavailable',
    message: 'Remote Alicorn runtime stopped responding; the stream connection was reset.'
  },
  {
    producer: 'remote-runtime-client.ts:842',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned binary data before authentication.'
  },
  {
    producer: 'remote-runtime-client.ts:852',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned an undecryptable binary frame.'
  },
  {
  ...
  producedPair(
    ...
    invalidRemoteRuntimeResponseError('Remote Alicorn runtime returned an invalid E2EE auth frame.')
  ),
  producedPair(
...
const SHARED_CONTROL_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  producedPair(
    ...
    remoteRuntimeUnavailableError(
      'Remote Alicorn runtime stopped responding; resetting the control connection.'
    )
  ),
  producedPair(
...
const HOST_FORWARDED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
    code: 'invalid_runtime_response',
    message: 'Remote Alicorn runtime returned an invalid response frame.'
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
...
const TAILSCALE_HINTED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  {
    ...
    message: withRemoteRuntimeTailscaleHint(
      'Could not connect to the remote Alicorn runtime.',
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: withRemoteRuntimeTailscaleHint(
      'Remote Alicorn runtime closed the connection.',
...
const CODELESS_TRANSPORT_ERRORS: (TransportErrorPair & { recoverable: boolean })[] = [
  {
    ...
    message: 'Remote Alicorn runtime is not connected.',
    recoverable: true
  },
  {
    producer: 'web-runtime-client.ts:359 / :360 / :591',
    message: 'Remote Alicorn runtime connection closed.',
    recoverable: true
  },
  {
