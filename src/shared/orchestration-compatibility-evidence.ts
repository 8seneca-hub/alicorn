...
export const ORCHESTRATION_COMPATIBILITY_HOST_KIND_ENV =
  'ALICORN_ORCHESTRATION_COMPATIBILITY_HOST_KIND'
export const ORCHESTRATION_COMPATIBILITY_HOST_ID_ENV = 'ALICORN_ORCHESTRATION_COMPATIBILITY_HOST_ID'
export const ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION_ENV =
  'ALICORN_ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION'
export const ORCHESTRATION_COMPATIBILITY_ATTACHMENT_ENV =
  'ALICORN_ORCHESTRATION_COMPATIBILITY_ATTACHMENT'
...
export function readOrchestrationCompatibilityEvidence(
  ...
  const terminalHandle = boundedValue(env.ALICORN_TERMINAL_HANDLE)
  const paneKey = boundedValue(env.ALICORN_PANE_KEY)
  const launchToken = boundedValue(env.ALICORN_AGENT_LAUNCH_TOKEN)
