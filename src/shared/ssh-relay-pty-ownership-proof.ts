 ...
 *  (`docs/reference/ssh-execution-boundary.md`): a second machine running the same Alicorn build
...
export type RelayPtyOwnershipEvidence = {
   ...
   *  from `agentSessionOwners`: that one asks whether Alicorn REGISTERED an agent session here, this
