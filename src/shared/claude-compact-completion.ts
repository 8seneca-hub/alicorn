// Claude's compact lifecycle, from Alicorn's side.
//
...
// path. So PreCompact proves nothing and Alicorn deliberately does not register it: mapping it to
...
// Stop, so Alicorn must not touch the state.
