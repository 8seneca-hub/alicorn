...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Alicorn’s built-in prompt for this action, including the context Alicorn knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Alicorn workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Alicorn has one available.',
