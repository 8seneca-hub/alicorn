...
describe('tab title resolution', () => {
  ...
  it('keeps OpenCode native and Alicorn-generated title behavior intact', () => {
    const aiVaultTitle = {
      ...
      resolveTerminalTabTitle(
        {
          customTitle: null,
          aiVaultTitle,
          generatedTitle: 'Alicorn generated',
    ...
    expect(
      resolveTerminalTabTitle(
        { customTitle: null, generatedTitle: 'Alicorn generated', title: '⠋ albacore' },
        true
      )
    ).toBe('Alicorn generated')
  })
