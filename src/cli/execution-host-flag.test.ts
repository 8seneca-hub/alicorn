...
describe('resolveHostFlagEnvironmentId', () => {
  ...
  it('rejects a runtime host id that no paired environment owns', async () => {
    ...
    ).rejects.toThrow('no paired Alicorn server is named or has id env-missing')
  })
  ...
  it('refuses a runtime host that disagrees with --environment', async () => {
    ...
    ).rejects.toThrow('name different Alicorn servers')
  })
  ...
  it('names the ambient variable when ALICORN_ENVIRONMENT is the conflicting selector', async () => {
    ...
    ).rejects.toThrow('ALICORN_ENVIRONMENT staging name different Alicorn servers')
  })
...
describe('assertEnvironmentSelectorResolvable', () => {
  ...
  it('still points at host list when the name is on neither axis', async () => {
    ...
    ).rejects.toThrow('no paired Alicorn server is named or has id nowhere')
  })
})
