...
export const TERMINAL_CLOSE_COMMAND_SPEC: CommandSpec = {
  ...
  usage:
    'alicorn terminal close ([--terminal <handle>] [--tab] | --worktree <selector> --all) [--json]',
  ...
  examples: [
    'alicorn terminal close --terminal term_abc123',
    'alicorn terminal close --terminal term_abc123 --tab --json',
    'alicorn terminal close --worktree active --all --json'
  ]
}
