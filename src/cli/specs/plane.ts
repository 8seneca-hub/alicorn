...
export const PLANE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage: 'orca plane issue <id|PROJ-123> [--project <id>] [--connection <id>] [--json]',
    ...
    examples: ['orca plane issue ALC-11', 'orca plane issue ALC-11 --json']
  },
  {
    path: ['plane', 'search'],
    summary: 'Search issues in a Plane project',
    usage:
      'orca plane search --project <id> [--state <group>] [--query <text>] [--limit <n>] [--connection <id>] [--json]',
    ...
    examples: [
      'orca plane search --project 2a53f690-4738-4491-b803-bbdf0a6e0cda --state started',
      'orca plane search --project <id> --query "auth" --limit 10 --json'
    ]
  },
  {
    path: ['plane', 'comment'],
    ...
    usage:
      'orca plane comment <id|PROJ-123> --body <text> [--project <id>] [--connection <id>] [--json]',
    ...
    examples: ['orca plane comment ALC-11 --body "Rebased onto main, CI is green."']
  },
  {
    path: ['plane', 'state'],
    summary: 'Move a Plane issue to a state',
    usage:
      'orca plane state <id|PROJ-123> --to <state-name> [--project <id>] [--connection <id>] [--json]',
    ...
    examples: ['orca plane state ALC-11 --to "In Review"', 'orca plane state ALC-11 --to Done']
  }
]
