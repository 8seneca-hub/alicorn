...
export const LINEAR_MCP_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'alicorn linear save-issue --team ENG --title "Fix auth" --priority high --json',
      'alicorn linear save-issue ENG-123 --title "Fix OAuth callback" --assignee me --json',
      'alicorn linear save-issue --current --project null --due-date null --json'
    ],
    notes: [
  ...
  },
  {
    ...
    examples: [
      'alicorn linear list-issues --team ENG --state started --assignee me --json',
      'alicorn linear list-issues --query auth --updated-at -P7D --json',
      'alicorn linear list-issues --assignee me --priority 1 --limit 100 --json',
      'alicorn linear list-issues --cursor <cursor> --json'
    ],
    notes: [
  ...
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'alicorn linear relation add ENG-1 --related ENG-2 --type blocks --json',
      'alicorn linear relation add --current --related ENG-2 --type blocked-by --json'
    ]
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'related', 'type', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['alicorn linear relation remove ENG-1 --related ENG-2 --type related --json']
  }
]
