...
export const SKILL_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage: 'alicorn skills installed [--json]',
    ...
    notes: [
      ...
      'Use an exact ID or an unambiguous name with `alicorn skills share --skill <selector>`.'
    ]
  },
  {
    path: ['skills', 'share'],
    ...
    usage:
      'alicorn skills share --skill <selector> [--skill <selector> ...] --bundle-name <name> ' +
    ...
    examples: [
      'alicorn skills share --skill frontend --bundle-name "Frontend Skills"',
      'alicorn skills share --skill frontend --skill testing --bundle-name "Team Toolkit" --json'
    ]
  },
  {
    path: ['skills', 'list'],
  ...
  },
  {
    ...
    examples: ['alicorn skills get orca-cli', 'alicorn skills get orchestration --full']
  },
  {
    path: ['skills', 'install'],
    ...
    examples: [
      'alicorn skills install',
      'alicorn skills install --skill orca-cli --skill orchestration',
      'alicorn skills install --skill orca-cli --local',
      'alicorn skills install --skill orca-cli --agent claude-code,codex',
      'alicorn skills install --all --dry-run'
    ]
  },
  {
    path: ['skills', 'update'],
    ...
    notes: [
      ...
      'Only refreshes skills that are already installed; use `alicorn skills install` first.',
      'Use --dry-run to print the resolved command without running it.',
    ...
    examples: [
      'alicorn skills update',
      'alicorn skills update --skill orca-cli --skill orchestration',
      'alicorn skills update --skill orca-cli --local',
      'alicorn skills update --all --dry-run'
    ]
  }
]
