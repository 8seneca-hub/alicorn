...
export const VM_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'alicorn vm recipe doctor <recipe-id> [--repo-path <path>] [--provision|--connect] [--json]',
    ...
    examples: [
      'alicorn vm recipe doctor cloud-sandbox',
      'alicorn vm recipe doctor cloud-sandbox --repo-path /path/to/repo --json',
      'alicorn vm recipe doctor cloud-sandbox --provision --json'
    ]
  }
]
