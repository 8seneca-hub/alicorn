...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Alicorn runtime server without opening a desktop window',
    usage:
      'alicorn serve [--port <port>] [--pairing-address <host>] [--mobile-pairing] [--no-pairing] [--project-root <path>] [--recipe-json] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'port',
      'pairing-address',
    ...
    examples: [
      'alicorn serve',
      'alicorn serve --json',
      'alicorn serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'alicorn serve --port 6768 --pairing-address 100.64.1.20',
      'alicorn serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
