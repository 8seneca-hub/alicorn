...
export const AUTOMATION_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['alicorn automations show 2f9e...', 'alicorn automations show --id 2f9e... --json']
  },
  {
    ...
    examples: [
      'alicorn automations create --name "Daily review" --trigger daily --prompt "Review open changes" --provider codex',
      'alicorn automations create --name "Weekday triage" --trigger "0 9 * * 1-5" --prompt "Triage issues" --provider claude --repo my-repo',
      'alicorn automations create --name "PR review" --trigger hourly --precheck "gh pr list --json number -q .[0].number" --prompt "Review requested PRs" --provider codex'
    ]
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'alicorn automations edit 2f9e... --disabled',
      'alicorn automations edit --id 2f9e... --trigger "30 * * * *" --json'
    ]
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'alicorn automations remove 2f9e...',
      'alicorn automations remove --id 2f9e... --json'
    ]
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'id'],
    positionalArgs: ['id'],
    examples: ['alicorn automations run 2f9e...', 'alicorn automations run --id 2f9e... --json']
  },
  {
    path: ['automations', 'runs'],
    summary: 'List automation run history',
    usage: 'alicorn automations runs [--id <automation-id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id'],
    examples: ['alicorn automations runs', 'alicorn automations runs --id 2f9e... --json']
  }
]
