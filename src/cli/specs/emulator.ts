...
export const EMULATOR_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage: 'alicorn emulator devices [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'attach'],
    summary: 'Attach/start helper for a device and make it active for the worktree',
    usage: 'alicorn emulator attach [device] [--worktree <selector>] [--focus] [--json]',
  ...
  },
  {
    ...
    usage: 'alicorn emulator tap <x> <y> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'alicorn emulator type <text> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: "alicorn emulator gesture '<json>' [--device <id>] [--worktree <selector>] [--json]",
  ...
  },
  {
    ...
    usage: 'alicorn emulator button <name> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'alicorn emulator rotate <orientation> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    path: ['emulator', 'exec'],
    summary:
      'Raw passthrough (e.g. alicorn emulator exec --command "tap 0.5 0.7" or "ca-debug blended on")',
    usage: 'alicorn emulator exec --command <cmd> [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'command', 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'kill'],
    summary: 'Stop helper for device',
    usage: 'alicorn emulator kill [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'alicorn emulator shutdown [--device <id>] [--emulator <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'install'],
    summary: 'Install an APK onto the target Android device',
    usage: 'alicorn emulator install <apkPath> [--reinstall] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'alicorn emulator launch <package> [--activity <name>] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'alicorn emulator permissions <grant|revoke> <package> <permission> [--device <id>] [--json]\n       alicorn emulator permissions reset [--device <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'device',
      'emulator',
  ...
  },
  {
    ...
    usage: 'alicorn emulator ax [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'logcat'],
    summary: 'Capture a one-shot logcat dump from the Android device',
    usage: 'alicorn emulator logcat [--lines <n>] [--device <id>] [--worktree <selector>] [--json]',
