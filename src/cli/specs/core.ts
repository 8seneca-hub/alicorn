...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  ...SERVE_COMMAND_SPECS,
  {
    ...
    usage: 'alicorn status [--json]',
    allowedFlags: [...GLOBAL_FLAGS],
    examples: ['alicorn status', 'alicorn status --json']
  },
  {
    path: ['claude-teams'],
  ...
  },
  {
    ...
    usage: 'alicorn worktree show --worktree <selector> [--json]',
  ...
  },
  {
    ...
    examples: [
      'alicorn worktree create --name agent-task --agent codex --prompt "hi" --json',
      'alicorn worktree create --repo id:<repoId> --name related-task --json',
      'alicorn worktree create --project github:stablyai/orca --host runtime:03ef704c-b180-4b10-998d-e28fbd5de9a3 --name benchmark --json',
      'alicorn worktree create --repo id:<repoId> --name linear-task --linear-issue https://linear.app/stably/issue/STA-335/test-issue --json',
      'alicorn worktree create --repo id:<repoId> --name agent-task --agent codex --prompt "hi" --json',
      'alicorn worktree create --repo id:<repoId> --name folder-child --parent-worktree folder:<folderId> --json',
      'alicorn worktree create --repo id:<repoId> --name related-task --parent-worktree active --json',
      'alicorn worktree create --repo id:<repoId> --name independent-task --no-parent --json'
    ]
  },
  {
    path: ['worktree', 'set'],
    ...
    examples: [
      'alicorn worktree set --worktree active --linear-issue STA-335 --json',
      'alicorn worktree set --worktree active --linear-issue null --json'
    ]
  },
  {
    path: ['worktree', 'rm'],
  ...
  },
  {
    ...
    usage: 'alicorn worktree ps [--limit <n>] [--json]',
  ...
  },
  {
    ...
    usage: 'alicorn terminal show [--terminal <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'alicorn terminal read [--terminal <handle>] [--cursor <n>] [--limit <n>] [--screen] [--json]',
    ...
    examples: [
      'alicorn terminal read --json',
      'alicorn terminal read --terminal term_abc123 --cursor 42 --limit 1000 --json',
      'alicorn terminal read --terminal term_abc123 --screen --json'
    ]
  },
  {
    path: ['terminal', 'send'],
    ...
    usage:
      'alicorn terminal send [--terminal <handle>] [--text <text>] [--enter] [--interrupt] [--json]',
  ...
  },
  {
    ...
    usage:
      'alicorn terminal wait [--terminal <handle>] --for exit|tui-idle [--timeout-ms <ms>] [--json]',
  ...
  },
  {
    ...
    usage: 'alicorn terminal stop --worktree <selector> [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree'],
    notes: [
  ...
  },
  {
    ...
    usage:
      'alicorn terminal create [--worktree <selector>] [--title <name>] [--command <text>] [--focus] [--json]',
    ...
    examples: [
      'alicorn terminal create --json',
      'alicorn terminal create --worktree active --command "codex" --json',
      'alicorn terminal create --worktree path:/projects/myapp --title "RUNNER" --command "opencode"',
      'alicorn terminal create --worktree path:/projects/myapp --command "opencode" --focus'
    ]
  },
  {
    ...
    usage: 'alicorn terminal switch [--terminal <handle>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'terminal'],
    examples: ['alicorn terminal switch --terminal term_abc123']
  },
  TERMINAL_CLOSE_COMMAND_SPEC,
  {
    path: ['terminal', 'rename'],
    summary: 'Set or clear the title of a terminal tab',
    usage: 'alicorn terminal rename [--terminal <handle>] [--title <text>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'terminal', 'title'],
    notes: ['Omit --title or pass an empty string to reset to the auto-generated title.'],
    examples: [
      'alicorn terminal rename --terminal term_abc123 --title "RUNNER"',
      'alicorn terminal rename --terminal term_abc123 --json'
    ]
  },
  {
    path: ['terminal', 'split'],
    ...
    usage:
      'alicorn terminal split [--terminal <handle>] [--direction horizontal|vertical] [--command <text>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'terminal', 'direction', 'command'],
    examples: [
      'alicorn terminal split --terminal term_abc123 --direction horizontal --json',
      'alicorn terminal split --terminal term_abc123 --command "codex"'
    ]
  }
]
