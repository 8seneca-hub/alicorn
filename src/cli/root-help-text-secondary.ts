export const ROOT_HELP_TEXT_SECONDARY = [
  ...
  '  alicorn status [--json]',
  '  alicorn diagnostics memory [--json]',
  '  alicorn agent-context [--json]',
  '  alicorn account add [--agent claude|codex] [--json]',
  '  alicorn account list [--json]',
  '  alicorn host list [--json]',
  '  alicorn environment add --name <name> --pairing-code <code> [--json]',
  '  alicorn environment list [--json]',
  '  alicorn environment show --environment <selector> [--json]',
  '  alicorn environment rm --environment <selector> [--json]',
  '  alicorn worktree list [--repo <selector>] [--limit <n>] [--json]',
  ...
  '  alicorn worktree show --worktree <selector> [--json]',
  '  alicorn worktree current [--json]',
  ...
  '  alicorn worktree rm --worktree <selector> [--force] [--run-hooks] [--json]',
  '  alicorn worktree ps [--limit <n>] [--json]',
  '  alicorn file open <path> [--worktree <selector>] [--json]',
  '  alicorn file diff <path> [--staged] [--worktree <selector>] [--json]',
  '  alicorn file open-changed [--mode edit|diff|both] [--worktree <selector>] [--json]',
  '  alicorn terminal list [--worktree <selector>] [--limit <n>] [--include-visual-layouts] [--json]',
  '  alicorn terminal show [--terminal <handle>] [--json]',
  '  alicorn terminal read [--terminal <handle>] [--cursor <n>] [--limit <n>] [--json]',
  ...
  '  alicorn terminal split [--terminal <handle>] [--direction horizontal|vertical] [--json]',
  '  alicorn terminal switch [--terminal <handle>] [--json]',
  '  alicorn terminal close ([--terminal <handle>] [--tab] | --worktree <selector> --all) [--json]',
  '  alicorn project list [--json]',
  '  alicorn project setups [--project <id>] [--host <host-id>] [--json]',
  ...
  '  alicorn project setup-delete --setup <setup-id> [--json]',
  '  alicorn repo list [--json]',
  '  alicorn repo add --path <path> [--json]',
  '  alicorn repo show --repo <selector> [--json]',
  '  alicorn repo set-base-ref --repo <selector> --ref <ref> [--json]',
  '  alicorn repo search-refs --repo <selector> --query <text> [--limit <n>] [--json]',
  '',
  'Selectors:',
  ...
  '  --terminal <handle>       Runtime-issued terminal handle returned by `alicorn terminal list --json`',
  ...
  '  --pairing-code <code>      Connect to a remote Alicorn runtime using an orca://pair?... code',
  '  --environment <selector>   Connect using a saved environment id or name',
  '  --help                    Show this help message',
  '',
  'Behavior:',
  '  Most commands require a running Alicorn runtime. If Alicorn is not open yet, run `alicorn open` first.',
  ...
  '',
  'Browser Workflow:',
  '  1. Create or navigate:  alicorn tab create --url https://example.com',
  '                          alicorn goto --url https://example.com',
  '  2. Inspect the page:    alicorn snapshot',
  '     (Returns an accessibility tree with element refs like e1, e2, e3)',
  '     For concurrent workflows, prefer: alicorn tab list --json',
  '     then reuse tabs[].browserPageId with --page <id> on later commands.',
  '  3. Interact:            alicorn click --element e2',
  '                          alicorn fill --element e5 --value "search query"',
  '                          alicorn keypress --key Enter',
  '  4. Re-inspect:          alicorn snapshot',
  ...
  '  $ alicorn diagnostics memory --json',
  '  $ alicorn repo list',
  '  $ alicorn worktree create --name agent-task --agent codex --prompt "hi"',
  '  $ alicorn worktree create --repo name:orca --name cli-test-1 --issue 273',
  '  $ alicorn worktree create --repo name:orca --name linear-task --linear-issue https://linear.app/stably/issue/STA-335/test-issue',
  '  $ alicorn worktree create --name linear-task --linear-issue STA-335',
  '  $ alicorn worktree show --worktree branch:Jinwoo-H/cli',
  '  $ alicorn worktree current',
  '  $ alicorn worktree set --worktree active --comment "waiting on review"',
  '  $ alicorn worktree set --worktree active --linear-issue null',
  '  $ alicorn worktree ps --limit 10',
  '  $ alicorn file open-changed --mode diff',
  '  $ alicorn file open src/App.tsx',
  '  $ alicorn terminal create --worktree active --command "codex"',
  '  $ alicorn terminal list --worktree path:/Users/me/orca/workspaces/orca/cli-test-1 --json',
  '  $ alicorn terminal send --terminal term_123 --text "hi" --enter',
  '  $ alicorn terminal wait --terminal term_123 --for exit --timeout-ms 60000 --json',
  '  $ alicorn tab current --json',
  '  $ alicorn tab show --page page_123 --json',
  '  $ alicorn tab create --url https://example.com --profile work',
  '  $ alicorn tab profile clone --page page_123 --profile work --json',
  '  $ alicorn snapshot',
  '  $ alicorn click --element e3',
  '  $ alicorn fill --element e5 --value "hello"',
  '  $ alicorn goto --url https://example.com/login',
  '  $ alicorn keypress --key Enter',
  '  $ alicorn eval --expression "document.title"',
  '  $ alicorn tab list --json'
].join('\n')
