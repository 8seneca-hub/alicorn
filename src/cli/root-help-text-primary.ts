export const ROOT_HELP_TEXT_PRIMARY = [
  'alicorn',
  '',
  'Usage: alicorn <command> [options]',
  '',
  'Startup:',
  '  open                      Launch Alicorn and wait for the runtime to be reachable',
  '  serve                     Start a headless Alicorn runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Alicorn and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Alicorn CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Alicorn skills globally via the community skills CLI',
  '  skills update             Update already-installed Alicorn skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Alicorn runtime from a pairing code',
  '  environment list          List saved remote Alicorn runtimes',
  '  environment show          Show one saved remote Alicorn runtime',
  '  environment rm            Remove a saved remote Alicorn runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled Alicorn automations',
  '  automations show          Show one Alicorn automation',
  '  automations create        Create a scheduled Alicorn automation',
  '  automations edit          Edit an Alicorn automation',
  '  automations remove        Remove an Alicorn automation and its run history',
  '  automations run           Run an Alicorn automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Alicorn',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Alicorn',
  '  repo add                  Add a project to Alicorn by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Alicorn-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Alicorn-managed worktree for the current directory',
  '  worktree create           Create a new Alicorn-managed worktree',
  '  worktree set              Update Alicorn metadata for a worktree',
  '  worktree rm               Remove a worktree from Alicorn and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Alicorn editor',
  '  file diff                 Open a workspace file diff in the Alicorn editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Alicorn-managed terminals',
  ...
  '  orchestration policy-get  Show the autonomy policy for a project stage',
  '  orchestration policy-set  Author the autonomy policy for a project stage',
  '  orchestration policy-list List authored policies and standing never_gate exceptions',
  '  orchestration evidence    Show a task track record and what the policy would decide',
  ...
  '  emulator list             List available/running emulators (Alicorn-managed + raw serve-sim)',
