...
// round-trip, even when Alicorn is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "Alicorn is not running" by the
