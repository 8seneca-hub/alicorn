...
describe('orca cli browser waits and viewport flags', () => {
  ...
  it('does not tell users Alicorn is down for a generic runtime timeout', async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith('Timed out waiting for the Alicorn runtime to respond.')
  })
