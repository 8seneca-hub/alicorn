...
//
declare const ALICORN_BUILD_IDENTITY: 'stable' | 'rc' | null
declare const ALICORN_POSTHOG_WRITE_KEY: string | null
...
// `ALICORN_DIAGNOSTICS_TOKEN_URL` env var, which env wins so a developer can
// point a packaged build at a staging server without re-running the
// release pipeline.
declare const ALICORN_DIAGNOSTICS_TOKEN_URL: string | null
