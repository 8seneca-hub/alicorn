...
import { ALICORN_PROFILE_AUTH_STATUS_CHANGED_CHANNEL } from '../../shared/orca-profiles'
...
export const orcaProfilesApi = {
  ...
  onAuthStatusChanged: (callback: () => void): (() => void) => {
    ...
    ipcRenderer.on(ALICORN_PROFILE_AUTH_STATUS_CHANGED_CHANNEL, listener)
    return () => ipcRenderer.removeListener(ALICORN_PROFILE_AUTH_STATUS_CHANGED_CHANNEL, listener)
  },
