...
describe('upsertHookTrustEntries', () => {
  ...
  it('finds and replaces a legacy forward-slash block when Alicorn upserts with native backslash key', () => {
  ...
  it('finds a Codex-written block with lowercased username when Alicorn key has mixed-case username', () => {
