...
export function getManagedScript(target: 'local' | 'posix' = 'local'): string {
  ...
  return [
    ...
    '          "set ALICORN_AGENT_HOOK_PORT="*) ALICORN_AGENT_HOOK_PORT=${endpoint_line#*=} ;;',
    '          "set ALICORN_AGENT_HOOK_TOKEN="*) ALICORN_AGENT_HOOK_TOKEN=${endpoint_line#*=} ;;',
    '          "set ALICORN_AGENT_HOOK_ENV="*) ALICORN_AGENT_HOOK_ENV=${endpoint_line#*=} ;;',
    '          "set ALICORN_AGENT_HOOK_VERSION="*) ALICORN_AGENT_HOOK_VERSION=${endpoint_line#*=} ;;',
    '          "set ALICORN_AGENT_HOOK_TRANSPORT="*) ALICORN_AGENT_HOOK_TRANSPORT=${endpoint_line#*=} ;;',
    '        esac',
    '      done < "$endpoint_path"',
    '      ;;',
    '    *)',
    ...
    '  load_hook_endpoint "$ALICORN_AGENT_HOOK_ENDPOINT"',
    'fi',
