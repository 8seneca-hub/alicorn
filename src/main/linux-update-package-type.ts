 ...
 * container rebuilds) unpack Alicorn's .deb and inherit its `package-type` verbatim, so the marker
 * describes the artifact Alicorn was built as, never the system that now owns the install. Without a
