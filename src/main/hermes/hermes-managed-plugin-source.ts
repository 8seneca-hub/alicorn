...
export const HERMES_PLUGIN_MARKER = 'Managed by Alicorn. Do not edit; changes may be overwritten.'
...
export function getPluginManifest(): string {
  return [
    ...
    'version: 1.0.0',
    'description: "Reports Hermes Agent lifecycle events to Alicorn."',
    'author: "Alicorn"',
    'kind: standalone',
    'provides_hooks:',
