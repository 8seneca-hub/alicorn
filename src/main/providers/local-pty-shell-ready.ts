 ...
 * that point each shell at its Alicorn wrapper (which emits the OSC 777 marker the scanner detects).
 */
...
/** Args that point bash at Alicorn's rcfile, or null when it is not usable. */
