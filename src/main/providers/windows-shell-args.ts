...
export const ALICORN_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV =
  'ALICORN_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined ALICORN_CODEX_LAUNCH_PREFLIGHT call %${ALICORN_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%ALICORN_CODEX_LAUNCH_PREFLIGHT%%${ALICORN_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment Alicorn detects.
