...
export function buildSshPtySpawnEnv(args: {
  ...
  if (args.remoteCliBridgeEnv) {
    ...
    merged.ALICORN_REMOTE_CLI_BIN_DIR = args.remoteCliBridgeEnv.binDir
    merged.ALICORN_RELAY_DIR = args.remoteCliBridgeEnv.relayDir
    merged.ALICORN_RELAY_NODE_PATH = args.remoteCliBridgeEnv.nodePath
    merged.ALICORN_RELAY_SOCKET_PATH = args.remoteCliBridgeEnv.sockPath
    if (args.remoteCliBridgeEnv.credentialFile) {
      merged.ALICORN_RELAY_CREDENTIAL_FILE = args.remoteCliBridgeEnv.credentialFile
    }
  }
