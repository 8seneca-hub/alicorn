...
export type HostedReviewExecutionOptions = {
  ...
  /** Paths Alicorn may have symlinked into this worktree. An untracked entry that
   *  is one of these is Alicorn's own artifact, not work the user can commit, so it
