 ...
 *
 * Probes are always secondary to Alicorn automation list and mutation traffic, so
...
export class ExternalAutomationProbeScheduler {
  ...
  /** Held for the duration of Alicorn list/mutation work; queued probes wait behind it. */
