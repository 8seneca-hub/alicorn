  ...
  const child = spawn(
    ...
    ],
    {
      ...
      env: {
        ...
        ALICORN_SKILL_UPLOAD_PROCESS_CHILD: '1',
        ALICORN_SKILL_UPLOAD_RESTART_ROOT: uploadRoot,
        ALICORN_SKILL_UPLOAD_RESTART_MARKER: marker,
        ALICORN_SKILL_UPLOAD_RESTART_BOUNDARY: boundary
      },
