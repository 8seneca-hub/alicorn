...
describe('OrcaRuntimeService', () => {
  ...
  it('rejects SSH lineage updates when Alicorn worktree identity is missing', async () => {
    const remoteRepo = {
      id: 'remote-repo',
      path: '/home/user/repo',
      displayName: 'remote',
  ...
  it('rejects local lineage updates when Alicorn worktree identity is missing', async () => {
