...
export const ACCOUNT_METHODS: readonly RpcAnyMethod[] = [
  ...
  defineMethod({
    ...
    handler: async (params, { runtime, clientKind }) => {
      ...
      if (clientKind !== undefined) {
        throw new Error('Adding Claude accounts is only available on the Alicorn host runtime.')
      }
  ...
  defineMethod({
    ...
    handler: async (params, { runtime, clientKind }) => {
      if (clientKind !== undefined) {
        throw new Error('Adding Codex accounts is only available on the Alicorn host runtime.')
      }
