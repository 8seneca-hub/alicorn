...
export const LINUX_PACKAGE_MARKER_UNUSABLE_MESSAGE =
  'Alicorn could not verify the installed Linux package format, so it will not install this update automatically. Download the update from the official release page and install it manually.'
export const LINUX_PACKAGE_EXTERNALLY_MANAGED_MESSAGE =
  'This copy of Alicorn is managed by your system package manager, so Alicorn cannot install updates itself. Update Alicorn through your distribution instead.'
export const LINUX_PACKAGE_MANUAL_INSTALL_MESSAGE =
  'Quit Alicorn before running the system package install command.'
const PACKAGE_METADATA_UNUSABLE_MESSAGE =
  'The downloaded package metadata could not be verified. Quit Alicorn before downloading and installing the update from the official release page.'
