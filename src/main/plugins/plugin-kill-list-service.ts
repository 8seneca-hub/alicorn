...
export const PLUGIN_KILL_LIST_URL = 'https://alicorn.8seneca.com/plugins/kill-list.json'
...
export class PluginKillListService {
  ...
  async initialize(): Promise<void> {
    this.loadPromise ??= this.store
      ...
      .catch((error) => {
        // Why: an unusable cache must not prevent Alicorn from starting; a valid
