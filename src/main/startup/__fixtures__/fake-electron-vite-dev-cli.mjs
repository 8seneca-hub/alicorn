...
const pidFile = process.env.ALICORN_DEV_WRAPPER_TEST_PID_FILE
const envFile = process.env.ALICORN_DEV_WRAPPER_TEST_ENV_FILE
...
if (!pidFile) {
  throw new Error('ALICORN_DEV_WRAPPER_TEST_PID_FILE is required')
}
    ...
    JSON.stringify(
      {
        ...
        label: process.env.ALICORN_DEV_INSTANCE_LABEL ?? null,
        branch: process.env.ALICORN_DEV_BRANCH ?? null,
        worktreeName: process.env.ALICORN_DEV_WORKTREE_NAME ?? null,
        repoRoot: process.env.ALICORN_DEV_REPO_ROOT ?? null,
        badgeLabel: process.env.ALICORN_DEV_DOCK_BADGE_LABEL ?? null,
        dockTitle: process.env.ALICORN_DEV_DOCK_TITLE ?? null,
        stableName: process.env.ALICORN_DEV_STABLE_NAME ?? null,
