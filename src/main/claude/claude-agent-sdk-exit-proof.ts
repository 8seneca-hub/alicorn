...
/**
 * Alicorn's own shutdown ladder on the child it spawned, kept because the SDK's
 * close path returns no proof and Alicorn never releases a lease on an assumed exit.
 *
