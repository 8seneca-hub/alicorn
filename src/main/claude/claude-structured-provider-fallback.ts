...
/**
 * What a message part that Alicorn cannot render says for itself. The kinds under
 ...
 */
export const CLAUDE_UNRENDERABLE_CONTENT_TEXT = 'Claude sent content Alicorn cannot display yet'
...
export function isModeledClaudeContent(value: unknown): boolean {
  ...
  if (part.type === 'image') {
    ...
    // A local attachment is replayed as the base64 (or file) source Alicorn itself
