...
/**
 * Run one native Query control method under Alicorn's deadline and error classification.
 *
...
/** The native control surface Alicorn drives, one method per Query control request. */
