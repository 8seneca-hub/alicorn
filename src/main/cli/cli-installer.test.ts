...
describe('CliInstaller', () => {
  ...
  it.skipIf(process.platform === 'win32')(
    ...
    async () => {
      ...
      expect(launcherContent).toContain(`export ALICORN_USER_DATA_PATH='${fixture.userDataPath}'`)
      expect(launcherContent).toContain('export ALICORN_APP_EXECUTABLE="$ELECTRON"')
