...
describe('CodexUsageStore', () => {
  ...
  it('reports no data for Alicorn scope when only non-Alicorn Codex usage exists', async () => {
  ...
  it('uses only Alicorn-scoped models when projecting mixed-scope sessions', async () => {
    const store = createStoreWithState({
      sessions: [
        {
          sessionId: 'session-1',
