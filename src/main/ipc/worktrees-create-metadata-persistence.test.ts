...
describe('registerWorktreeHandlers', () => {
  ...
  it('strips Alicorn provenance fields from renderer metadata updates', () => {
  ...
  // Was "keeps the Alicorn-created marker ...": create used to inherit the marker while
  ...
  it('does not claim the Alicorn-created marker at create when a sibling worktree minted the fork remote', async () => {
    listWorktreesMock.mockResolvedValue([
      {
        path: '/workspace/improve-dashboard',
        head: 'abc123',
