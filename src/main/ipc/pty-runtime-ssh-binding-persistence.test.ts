...
describe('registerPtyHandlers', () => {
  ...
  it('strips runtime-owned SSH pane env when remote agent hooks are disabled', async () => {
    ...
    const savedRemoteHooks = process.env.ALICORN_FEATURE_REMOTE_AGENT_HOOKS
    ...
    try {
      ...
      await spawnController.spawn({
        ...
        env: {
          FOO: 'bar',
          ALICORN_PANE_KEY: makePaneKey('tab-remote', leafId),
          ALICORN_TAB_ID: 'tab-remote',
          ALICORN_WORKTREE_ID: 'wt-remote'
        },
      ...
      if (savedRemoteHooks === undefined) {
        ...
        process.env.ALICORN_FEATURE_REMOTE_AGENT_HOOKS = savedRemoteHooks
      }
