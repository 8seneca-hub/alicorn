...
const FEEDBACK_API_URL = 'https://www.alicorn.8seneca.com/v1/feedback'
...
// which Alicorn build and which OS the feedback came from. The main process is
...
export async function submitFeedback(
  ...
  try {
    ...
    // Why: api.alicorn.8seneca.com serves a different product, so transient failures
