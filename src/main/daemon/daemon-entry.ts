...
async function main(): Promise<void> {
  ...
  const e2eProbeFile = process.env.ALICORN_E2E_LOGIN_SESSION_PROBE_FILE
...
const isDirectExecution = !process.env.VITEST && !process.env.ALICORN_DAEMON_ENTRY_LOAD_CHECK
