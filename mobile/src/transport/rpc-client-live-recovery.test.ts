...
//   ALICORN_MOBILE_LIVE_REPRO=1 pnpm vitest run src/transport/rpc-client-live-recovery.test.ts
//   ALICORN_MOBILE_LIVE_REPRO_FULL=1 ... (adds the 8-minute parked-loop case)
...
const RUN_LIVE =
  process.env.ALICORN_MOBILE_LIVE_REPRO === '1' || !!process.env.ALICORN_MOBILE_LIVE_REPRO_FULL
const RUN_FULL = process.env.ALICORN_MOBILE_LIVE_REPRO_FULL === '1'
...
describe.runIf(!RUN_LIVE)('live foreground recovery (skipped)', () => {
  it('is opt-in via ALICORN_MOBILE_LIVE_REPRO=1', () => {
